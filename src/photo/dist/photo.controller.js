...
var PhotoController = /** @class */ (function () {
  ...
  PhotoController.prototype.updateImage = function (file, user, publicId) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        return [
          2 /*return*/,
          this._photoService.updateImage(file, id, publicId),
        ];
      });
    });
  };
  ...
  __decorate(
    [
      ...
      common_1.UseGuards(auth_guard_1.AuthenticationGuard),
      common_1.Post(),
      decorators_1.UseInterceptors(
        platform_express_1.FilesInterceptor('files'),
      ),
  ...
  PhotoController = __decorate([common_1.Controller('photo')], PhotoController);
