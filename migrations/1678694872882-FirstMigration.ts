...
export class FirstMigration1678694872882 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "profile" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "name" character varying NOT NULL, "gender" "public"."profile_gender_enum" NOT NULL, "birthday" TIMESTAMP NOT NULL, "description" character varying NOT NULL, "float" integer NOT NULL, "religion" character varying NOT NULL, "drinking" boolean NOT NULL, "education" character varying NOT NULL, "have_children" boolean NOT NULL, "interests" text array NOT NULL, "user_id" uuid, CONSTRAINT "REL_d752442f45f258a8bdefeebb2f" UNIQUE ("user_id"), CONSTRAINT "PK_3dd8bfc97e4a77c70971591bdcb" PRIMARY KEY ("id"))`);
